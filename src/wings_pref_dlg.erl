...
gen_prefs() ->
	...
	{vframe,
	 ...
	 [{label_column,
	  ...
	  {hframe,
	     [{?__(61,"Verbose"),enhanced_info_text,
...
constraint_prefs() ->
    ...
    Set_Con_Default = [{"Alt",alt},
                       {"Shift",shift},
                       {"Ctrl",ctrl},
                       {"Ctrl+Shift",ctrl_shift},
                       {"Ctrl+Alt",ctrl_alt},
                       {"Shift+Alt",shift_alt},
                       {"Ctrl+Shift+Alt",ctrl_shift_alt}],
	 ...
	 [{label_column,
	   [{("Alt"),dist_con_alt,
	     [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
          ["[Alt]"])},{range,{?NONZERO,1000.0,10.0}}]},
	    {("Shift"),dist_con_shift,
	     [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
          ["[Shift]"])},{range,{?NONZERO,1000.0,1.0}}]},
	    {("Ctrl"),dist_con_ctrl,
	     [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
          ["[Ctrl]"])},{range,{?NONZERO,1000.0,0.1}}]},
	    {("Ctrl+Shift"),dist_con_ctrl_shift,
	     [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
          ["[Ctrl]+[Shift]"])},{range,{?NONZERO,1000.0,0.01}}]},
	    {("Ctrl+Alt"),dist_con_ctrl_alt,
	     [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
          ["[Ctrl]+[Alt]"])},{range,{?NONZERO,1000.0,0.001}}]},
	    {("Shift+Alt"),dist_con_shift_alt,
	     [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
          ["[Shift]+[Alt]"])},{range,{?NONZERO,1000.0,0.25}}]},
	    {("Ctrl+Shift+Alt"),dist_con_ctrl_shift_alt,
	     [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
          ["[Ctrl]+[Shift]+[Alt]"])},{range,{?NONZERO,1000.0,0.025}}]}]}],
     ...
     [{label_column,
       [{("Alt"),scale_con_alt,
         [{info,wings_util:format(?__(14,"Constraint bound to ~s for scale operations."),
          ["[Alt]"]) ++ ?__(15," Alternate constrains to reciprocal (1.0/Value).")},
          {range,{?NONZERO, 1000.0, 10.0}}]},
        {("Shift"),scale_con_shift,
         [{info,wings_util:format(?__(14,"Constraint bound to ~s for scale operations."),
          ["[Shift]"]) ++ ?__(15," Alternate constrains to reciprocal (1.0/Value).")},
          {range,{?NONZERO, 1000.0, 1.0}}]},
        {("Ctrl"),scale_con_ctrl,
         [{info,wings_util:format(?__(14,"Constraint bound to ~s for scale operations."),
          ["[Ctrl]"]) ++ ?__(15," Alternate constrains to reciprocal (1.0/Value).")},
          {range,{?NONZERO, 1000.0, 0.1}}]},
        {("Ctrl+Shift"),scale_con_ctrl_shift,
         [{info,wings_util:format(?__(14,"Constraint bound to ~s for scale operations."),
          ["[Ctrl]+[Shift]"]) ++ ?__(15," Alternate constrains to reciprocal (1.0/Value).")},
          {range,{?NONZERO, 1000.0, 0.01}}]},
        {("Ctrl+Alt"),scale_con_ctrl_alt,
         [{info,wings_util:format(?__(14,"Constraint bound to ~s for scale operations."),
          ["[Ctrl]+[Alt]"]) ++ ?__(15," Alternate constrains to reciprocal (1.0/Value).")},
          {range,{?NONZERO, 1000.0, 0.5}}]},
        {("Shift+Alt"),scale_con_shift_alt,
         [{info,wings_util:format(?__(14,"Constraint bound to ~s for scale operations."),
          ["[Shift]+[Alt]"]) ++ ?__(15," Alternate constrains to reciprocal (1.0/Value).")},
          {range,{?NONZERO, 1000.0, 0.25}}]},
        {("Ctrl+Shift+Alt"),scale_con_ctrl_shift_alt,
         [{info,wings_util:format(?__(14,"Constraint bound to ~s for scale operations."),
          ["[Ctrl]+[Shift]+[Alt]"]) ++ ?__(15," Alternate constrains to reciprocal (1.0/Value).")},
     ...
     [{vframe,
      [{vframe,
       [{label_column,
        [{("Alt"),dist_con_a_alt,
         [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
          ["[Alt]"])++wings_util:format(?__(17,"(default 1/~s)"),["64"])},{range,{?NONZERO, 1000.0, 1/64}}]},
        {("Shift"),dist_con_a_shift,
         [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
          ["[Shift]"])++wings_util:format(?__(17,"(default 1/~s)"),["4"])},{range,{?NONZERO, 1000.0, 1/4}}]},
        {("Ctrl"),dist_con_a_ctrl,
         [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
          ["[Ctrl]"])++wings_util:format(?__(17,"(default 1/~s)"),["8"])},{range,{?NONZERO, 1000.0, 1/8}}]},
        {("Ctrl+Shift"),dist_con_a_ctrl_shift,
         [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
          ["[Ctrl]+[Shift]"])++wings_util:format(?__(17,"(default 1/~s)"),["32"])},{range,{?NONZERO, 1000.0, 1/32}}]},
        {("Ctrl+Alt"),dist_con_a_ctrl_alt,
         [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
          ["[Ctrl]+[Alt]"])++?__(18,"(default 5/8)")},{range,{?NONZERO, 1000.0, 5/8}}]},
        {("Shift+Alt"),dist_con_a_shift_alt,
         [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
          ["[Shift]+[Alt]"])++wings_util:format(?__(17,"(default 1/~s)"),["16"])},{range,{?NONZERO, 1000.0, 1/16}}]},
        {("Ctrl+Shift+Alt"),dist_con_a_ctrl_shift_alt,
         [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
          ["[Ctrl]+[Shift]+[Alt]"])++?__(19,"(default 3/64)")},{range,{?NONZERO, 1000.0, 3/64}}]}]}],
	 ...
	 [{label_column,
	   [{("Alt"),rot_con_alt,
	     [{info,wings_util:format(?__(13,"Constraint bound to ~s for rotations."),
          ["[Alt]"]) ++ ?__(16," Alternate constrains to supplementary (180.0 minus angle).")},
          {range,{?NONZERO, 360.0, 180.0}}]},
	    {("Shift"),rot_con_shift,
	     [{info,wings_util:format(?__(13,"Constraint bound to ~s for rotations."),
          ["[Shift]"]) ++ ?__(16," Alternate constrains to supplementary (180.0 minus angle).")},
          {range,{?NONZERO, 360.0, 15.0}}]},
	    {("Ctrl"),rot_con_ctrl,
	     [{info,wings_util:format(?__(13,"Constraint bound to ~s for rotations."),
          ["[Ctrl]"]) ++ ?__(16," Alternate constrains to supplementary (180.0 minus angle).")},
          {range,{?NONZERO, 360.0, 1.0}}]},
	    {("Ctrl+Shift"),rot_con_ctrl_shift,
	     [{info,wings_util:format(?__(13,"Constraint bound to ~s for rotations."),
          ["[Ctrl]+[Shift]"]) ++ ?__(16," Alternate constrains to supplementary (180.0 minus angle).")},
          {range,{?NONZERO, 360.0, 0.1}}]},
	    {("Ctrl+Alt"),rot_con_ctrl_alt,
	     [{info,wings_util:format(?__(13,"Constraint bound to ~s for rotations."),
          ["[Ctrl]+[Alt]"]) ++ ?__(16," Alternate constrains to supplementary (180.0 minus angle).")},
          {range,{?NONZERO, 360.0, 22.5}}]},
	    {("Shift+Alt"),rot_con_shift_alt,
	     [{info,wings_util:format(?__(13,"Constraint bound to ~s for rotations."),
          ["[Shift]+[Alt]"]) ++ ?__(16," Alternate constrains to supplementary (180.0 minus angle).")},
          {range,{?NONZERO, 360.0, 135.0}}]},
	    {("Ctrl+Shift+Alt"),rot_con_ctrl_shift_alt,
	     [{info,wings_util:format(?__(13,"Constraint bound to ~s for rotations."),
          ["[Ctrl]+[Shift]+[Alt]"]) ++ ?__(16," Alternate constrains to supplementary (180.0 minus angle).")},
	...
	{vframe,
          [{?__(40,"Factor in Distance from Camera"),absolute_cam_dist},
           {hframe,
              [{slider,{text,absolute_speed,[{range,{1.0,10.0}}]}}]}],
          [{title,?__(42,"Absolute Speed")},{hook,Disable}]},
         {vframe,
          [{?__(43,"Factor in Distance from Camera"),relative_cam_dist},
            {hframe,
              [{slider,{text,relative_speed,[{range,{1.0,10.0}}]}}]}],
           [{title,?__(46,"Relative Speed")},{hook,Disable}]},
         {vframe,
          [{hframe,
           [{slider,{text,rotations_speed,[{range,{1.0,10.0}}]}}]}],
     ...
     [{hframe,
       [{vframe,
        [{label,?__(1,"Distance")},
         ...
         {label,?__(3,"Scale")}]},
       {vframe,
        [{menu,Set_Con_Default,dist_con_default},
         {menu,Set_Con_Default,rot_con_default},
         {menu,Set_Con_Default,scale_con_default}]}],
     [{title,?__(4,"Default Modifier Keys")}]},
       {hframe,
        [{vradio,[{?__(9,"Distance Constraints"),dist_con_},
          % ends with _ to allow atom_to_string completion
          {?__(10,"Alternate Distances"),dist_con_a_}], dist_con_set}],
       [{title,?__(11,"Save Constraints to...")}]},
       {?__(33,"Use Alternate Constraints"),alternate_con,
