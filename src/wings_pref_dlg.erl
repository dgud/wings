...
command(prefs, St) ->
    PrefQs0 = [{?__(1,"General"),gen_prefs()},
	       ...
	       {?__(4,"Constraints"),constraint_prefs()},
	       {?__(5,"User Interface"),ui_prefs()},
	       {?__(6,"Misc"),misc_prefs()}],
    PrefQs = [{Lbl,make_query(Ps)} || {Lbl,Ps} <- PrefQs0],
    Qs = [{oframe,PrefQs,1,[{style,buttons}]}],
    wings_ask:dialog(?__(7,"Preferences"), Qs,
		     fun([_|Res]) ->
...
constraint_prefs() ->
    DistConDefault = [{"Alt",dist_con_alt},
		      {"Shift",dist_con_shift},
		      {"Ctrl",dist_con_ctrl},
		      {"Ctrl+Shift",dist_con_ctrl_shift},
		      {"Ctrl+Alt",dist_con_ctrl_alt},
		      {"Shift+Alt",dist_con_shift_alt},
		      {"Ctrl+Shift+Alt",dist_con_ctrl_shift_alt}],
    RotConDefault =  [{"Alt",rot_con_alt},
		      {"Shift",rot_con_shift},
		      {"Ctrl",rot_con_ctrl},
		      {"Ctrl+Shift",rot_con_ctrl_shift},
		      {"Ctrl+Alt",rot_con_ctrl_alt},
		      {"Shift+Alt",rot_con_shift_alt},
		      {"Ctrl+Shift+Alt",rot_con_ctrl_shift_alt}],
    {vframe,
     [{hframe,
       [{vframe,
	 [{label_column,
	   [{?__(1,"Alt"),dist_con_alt,
	     [{info,?__(2,"Constraint assigned to [Alt] for distance operations")},{range,{0.0,1000.0}}]},
	    {?__(3,"Shift"),dist_con_shift,
	     [{info,?__(4,"Constraint assigned to [Shift] for distance operations")},{range,{0.0,1000.0}}]},
	    {?__(5,"Ctrl"),dist_con_ctrl,
	     [{info,?__(6,"Constraint assigned to [Ctrl] for distance operations")},{range,{0.0,1000.0}}]},
	    {?__(7,"Ctrl+Shift"),dist_con_ctrl_shift,
	     [{info,?__(8,"Constraint assigned to [Ctrl]+[Shift] for distance operations")},{range,{0.0,1000.0}}]},
	    {?__(9,"Ctrl+Alt"),dist_con_ctrl_alt,
	     [{info,?__(10,"Constraint assigned to [Ctrl]+[Alt] for distance operations")},{range,{0.0,1000.0}}]},
	    {?__(11,"Shift+Alt"),dist_con_shift_alt,
	     [{info,?__(12,"Constraint assigned to [Shift]+[Alt] for distance operations")},{range,{0.0,1000.0}}]},
	    {?__(13,"Ctrl+Shift+Alt"),dist_con_ctrl_shift_alt,
	     [{info,?__(14,"Constraint assigned to [Ctrl]+[Shift]+[Alt] for distance operations")},{range,{0.0,1000.0}}]}]}],
	 [{title,?__(15,"Distance Constraints")}]},
	{vframe,
	 [{label_column,
	   [{?__(16,"Alt"),rot_con_alt,
	     [{info,?__(17,"Constraint assigned to [Alt] for rotation operations")},{range,{0.0,360.0}}]},
	    {?__(18,"Shift"),rot_con_shift,
	     [{info,?__(19,"Constraint assigned to [Shift] for rotation operations")},{range,{0.0,360.0}}]},
	    {?__(20,"Ctrl"),rot_con_ctrl,
	     [{info,?__(21,"Constraint assigned to [Ctrl] for rotation operations")},{range,{0.0,360.0}}]},
	    {?__(22,"Ctrl+Shift"),rot_con_ctrl_shift,
	     [{info,?__(23,"Constraint assigned to [Ctrl]+[Shift] for rotation operations")},{range,{0.0,360.0}}]},
	    {?__(24,"Ctrl+Alt"),rot_con_ctrl_alt,
	     [{info,?__(25,"Constraint assigned to [Ctrl]+[Alt] for rotation operations")},{range,{0.0,360.0}}]},
	    {?__(26,"Shift+Alt"),rot_con_shift_alt,
	     [{info,?__(27,"Constraint assigned to [Shift]+[Alt] for rotation operations")},{range,{0.0,360.0}}]},
	    {?__(28,"Ctrl+Shift+Alt"),rot_con_ctrl_shift_alt,
	     [{info,?__(29,"Constraint assigned to [Ctrl]+[Shift]+[Alt] for rotation operations")},{range,{0.0,360.0}}]}]}],
	 [{title,?__(30,"Rotation Constraints")}]}]},

      {hframe,
       [{vframe,
	 [{label_column,
	   [{?__(31,"Alt"),scale_con_alt,
	     [{info,?__(32,"Constraint assigned to [Alt] for scale operations")},{range,{0.0,1000.0}}]},
	    {?__(33,"Shift"),scale_con_shift,
	     [{info,?__(34,"Constraint assigned to [Shift] for scale operations")},{range,{0.0,1000.0}}]},
	    {?__(35,"Ctrl"),scale_con_ctrl,
	     [{info,?__(36,"Constraint assigned to [Ctrl] for scale operations")},{range,{0.0,1000.0}}]},
	    {?__(37,"Ctrl+Shift"),scale_con_ctrl_shift,
	     [{info,?__(38,"Constraint assigned to [Ctrl]+[Shift] for scale operations")},{range,{0.0,1000.0}}]},
	    {?__(39,"Ctrl+Alt"),scale_con_ctrl_alt,
	     [{info,?__(40,"Constraint assigned to [Ctrl]+[Alt] for scale operations")},{range,{0.0,1000.0}}]},
	    {?__(41,"Shift+Alt"),scale_con_shift_alt,
	     [{info,?__(42,"Constraint assigned to [Shift]+[Alt] for scale operations")},{range,{0.0,1000.0}}]},
	    {?__(43,"Ctrl+Shift+Alt"),scale_con_ctrl_shift_alt,
	     [{info,?__(44,"Constraint assigned to [Ctrl]+[Shift]+[Alt] for scale operations")},{range,{0.0,1000.0}}]}]}],
	 [{title,?__(45,"Scale Constraints")}]},
	{vframe,
	 [{hframe,[{label,?__(46,"Distance")},{menu,DistConDefault,dist_con_default}]},
	  {hframe,[{label,?__(47,"Rotation")},{menu,RotConDefault,rot_con_default}]}],
	 [{title,?__(48,"Set Constraint Defaults")}]}]}]}.
