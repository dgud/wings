	 ...
	 [{label_column,
	   [{("Alt"),dist_con_alt,
	     [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
		  ["[Alt]"])},{range,{0.0,1000.0}}]},
	    {("Shift"),dist_con_shift,
	     [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
		  ["[Shift]"])},{range,{0.0,1000.0}}]},
	    {("Ctrl"),dist_con_ctrl,
	     [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
		  ["[Ctrl]"])},{range,{0.0,1000.0}}]},
	    {("Ctrl+Shift"),dist_con_ctrl_shift,
	     [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
		  ["[Ctrl]+[Shift]"])},{range,{0.0,1000.0}}]},
	    {("Ctrl+Alt"),dist_con_ctrl_alt,
	     [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
		  ["[Ctrl]+[Alt]"])},{range,{0.0,1000.0}}]},
	    {("Shift+Alt"),dist_con_shift_alt,
	     [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
		  ["[Shift]+[Alt]"])},{range,{0.0,1000.0}}]},
	    {("Ctrl+Shift+Alt"),dist_con_ctrl_shift_alt,
	     [{info,wings_util:format(?__(12,"Constraint bound to ~s for distance operations."),
		  ["[Ctrl]+[Shift]+[Alt]"])},{range,{0.0,1000.0}}]}]}],
	...
	{vframe,
	 [{label_column,
	   [{("Alt"),rot_con_alt,
	    ...
	    {("Shift"),rot_con_shift,
	     [{info,wings_util:format(?__(13,"Constraint bound to ~s for rotations."),
		  ["[Shift]"])},{range,{0.0,360.0}}]},
	    {("Ctrl"),rot_con_ctrl,
	     [{info,wings_util:format(?__(13,"Constraint bound to ~s for rotations."),
		  ["[Ctrl]"])},{range,{0.0,360.0}}]},
	    {("Ctrl+Shift"),rot_con_ctrl_shift,
	     [{info,wings_util:format(?__(13,"Constraint bound to ~s for rotations."),
		  ["[Ctrl]+[Shift]"])},{range,{0.0,360.0}}]},
	    {("Ctrl+Alt"),rot_con_ctrl_alt,
	     [{info,wings_util:format(?__(13,"Constraint bound to ~s for rotations."),
		  ["[Ctrl]+[Alt]"])},{range,{0.0,360.0}}]},
	    {("Shift+Alt"),rot_con_shift_alt,
	     [{info,wings_util:format(?__(13,"Constraint bound to ~s for rotations."),
		  ["[Shift]+[Alt]"])},{range,{0.0,360.0}}]},
	    {("Ctrl+Shift+Alt"),rot_con_ctrl_shift_alt,
	     [{info,wings_util:format(?__(13,"Constraint bound to ~s for rotations."),
		  ["[Ctrl]+[Shift]+[Alt]"])},{range,{0.0,360.0}}]}]}],
	 ...
	 [{label_column,
	   [{("Alt"),scale_con_alt,
	    ...
	    {("Ctrl+Shift+Alt"),scale_con_ctrl_shift_alt,
	     [{info,wings_util:format(?__(14,"Constraint bound to ~s for scale operations."),
		  ["[Ctrl]+[Shift]+[Alt]"])},{range,{0.0,1000.0}}]}]}],
	 [{title,?__(24,"Scale Constraints")}]},
	{vframe,
	 [{hframe,[{label,?__(1,"Distance")},{menu,DistConDefault,dist_con_default}]},
	  {hframe,[{label,?__(2,"Rotation")},{menu,RotConDefault,rot_con_default}]}],
	 [{title,?__(4,"Set Constraint Defaults")}]}]}]}.
