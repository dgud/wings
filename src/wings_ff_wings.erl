                ...
                {Shps,Objs1,Lgts} =
                    case {MrgObj,MrgLgt} of
                        ...
                        _ ->
                            ...
                            {gb_trees:from_orddict(Shps1),Objs0,Lgts0}
                    end,

                %% processing materials lists in accord with the user choice
                Materials1 = if MrgMtl=:=used -> used_material_list(Materials0,Objs1,Lgts);
                              true -> Materials0
                           end,
...
replace_perm_0(locked, true=_Unlock, false=_Unhide) -> undefined;
replace_perm_0(locked, _, _) -> locked;
replace_perm_0(hidden, false, true) -> undefined;
replace_perm_0(hidden, _, _) -> hidden;
replace_perm_0({hidden,_,_}, false, true) -> undefined;
replace_perm_0(hidden_locked, true, true) -> undefined;
replace_perm_0(hidden_locked, true, false) -> locked;
replace_perm_0(hidden_locked, false, true) -> hidden;
