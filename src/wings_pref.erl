...
defaults() ->
    [{background_color,{0.8,0.8,0.8}},
     ...
     {default_mat,{1.0,1.0,1.0}},
     {hole_mat,{0.0,0.0,0.9}},
     ...
     {dist_con_shift_alt,0.250},
     {dist_con_ctrl_shift_alt,0.0250},

     {dist_con_a_alt,1/64},
     {dist_con_a_shift,1/4},
     {dist_con_a_ctrl,1/8},
     {dist_con_a_ctrl_shift,1/32},
     {dist_con_a_ctrl_alt,5/8},
     {dist_con_a_shift_alt,1/16},
     {dist_con_a_ctrl_shift_alt,3/64},
     ...
     {scale_con_shift,1.0},
     {scale_con_ctrl,0.10},
     {scale_con_ctrl_shift,0.010},
     {scale_con_ctrl_alt,0.0010},
     {scale_con_shift_alt,0.250},
     {scale_con_ctrl_shift_alt,0.0250},

     {alternate_con,false},
     {dist_con_set,dist_con_},

     {dist_con_default,alt},
     {rot_con_default,alt},
     {scale_con_default,alt},

     %% Drag preferences.
     {drag_resets,false},
     {drag_custom,false},
     {absolute_cam_dist,true},
     {absolute_speed,5.0},
     {relative_cam_dist,true},
     {relative_speed,5.0},
     {rotations_speed,5.0},
