...
-define(DEF_RENDER_PASS1, disabled).
-define(DEF_RENDER_PASS2, disabled).
-define(DEF_RENDER_PASS3, disabled).
-define(DEF_RENDER_PASS4, disabled).
-define(DEF_RENDER_PASS5, disabled).
-define(DEF_RENDER_PASS6, disabled).
-define(DEF_RENDER_PASS7, disabled).
-define(DEF_RENDER_PASS8, disabled).
-define(DEF_RENDER_PASS9, disabled).
-define(DEF_RENDER_PASS10, disabled).
-define(DEF_RENDER_PASS11, disabled).
-define(DEF_RENDER_PASS12, disabled).
-define(DEF_RENDER_PASS13, disabled).
-define(DEF_RENDER_PASS14, disabled).
-define(DEF_RENDER_PASS15, disabled).
-define(DEF_RENDER_PASS16, disabled).
-define(DEF_RENDER_PASS17, disabled).
-define(DEF_RENDER_PASS18, disabled).
-define(DEF_RENDER_PASS19, disabled).
-define(DEF_RENDER_PASS20, disabled).
-define(DEF_RENDER_PASS21, disabled).
-define(DEF_RENDER_PASS22, disabled).
-define(DEF_RENDER_PASS23, disabled).
-define(DEF_RENDER_PASS24, disabled).
-define(DEF_RENDER_PASS25, disabled).
-define(DEF_RENDER_PASS26, disabled).
-define(DEF_RENDER_PASS27, disabled).
-define(DEF_RENDER_PASS28, disabled).
-define(DEF_RENDER_PASS29, disabled).
-define(DEF_RENDER_PASS30, disabled).
-define(DEF_RENDER_PASS31, disabled).
-define(DEF_RENDER_PASS32, disabled).
...
export_prefs() ->
    [{subdivisions,?DEF_SUBDIVISIONS},
        ...
        {dof_distance,?DEF_DOF_DISTANCE},
        {render_pass1,?DEF_RENDER_PASS1},
        {render_pass2,?DEF_RENDER_PASS2},
        {render_pass3,?DEF_RENDER_PASS3},
        {render_pass4,?DEF_RENDER_PASS4},
        {render_pass5,?DEF_RENDER_PASS5},
        {render_pass6,?DEF_RENDER_PASS6},
        {render_pass7,?DEF_RENDER_PASS7},
        {render_pass8,?DEF_RENDER_PASS8},
        {render_pass9,?DEF_RENDER_PASS9},
        {render_pass10,?DEF_RENDER_PASS10},
        {render_pass11,?DEF_RENDER_PASS11},
        {render_pass12,?DEF_RENDER_PASS12},
        {render_pass13,?DEF_RENDER_PASS13},
        {render_pass14,?DEF_RENDER_PASS14},
        {render_pass15,?DEF_RENDER_PASS15},
        {render_pass16,?DEF_RENDER_PASS16},
        {render_pass17,?DEF_RENDER_PASS17},
        {render_pass18,?DEF_RENDER_PASS18},
        {render_pass19,?DEF_RENDER_PASS19},
        {render_pass20,?DEF_RENDER_PASS20},
        {render_pass21,?DEF_RENDER_PASS21},
        {render_pass22,?DEF_RENDER_PASS22},
        {render_pass23,?DEF_RENDER_PASS23},
        {render_pass24,?DEF_RENDER_PASS24},
        {render_pass25,?DEF_RENDER_PASS25},
        {render_pass26,?DEF_RENDER_PASS26},
        {render_pass27,?DEF_RENDER_PASS27},
        {render_pass28,?DEF_RENDER_PASS28},
        {render_pass29,?DEF_RENDER_PASS29},
        {render_pass30,?DEF_RENDER_PASS30},
        {render_pass31,?DEF_RENDER_PASS31},
        {render_pass32,?DEF_RENDER_PASS32}].
...
export_render(F, CameraName, BackgroundName, Outfile, Attr) ->
    ...
    RenderPass1 = proplists:get_value(render_pass1, Attr),
    RenderPass2 = proplists:get_value(render_pass2, Attr),
    RenderPass3 = proplists:get_value(render_pass3, Attr),
    RenderPass4 = proplists:get_value(render_pass4, Attr),
    RenderPass5 = proplists:get_value(render_pass5, Attr),
    RenderPass6 = proplists:get_value(render_pass6, Attr),
    RenderPass7 = proplists:get_value(render_pass7, Attr),
    RenderPass8 = proplists:get_value(render_pass8, Attr),
    RenderPass9 = proplists:get_value(render_pass9, Attr),
    RenderPass10 = proplists:get_value(render_pass10, Attr),
    RenderPass11 = proplists:get_value(render_pass11, Attr),
    RenderPass12 = proplists:get_value(render_pass12, Attr),
    RenderPass13 = proplists:get_value(render_pass13, Attr),
    RenderPass14 = proplists:get_value(render_pass14, Attr),
    RenderPass15 = proplists:get_value(render_pass15, Attr),
    RenderPass16 = proplists:get_value(render_pass16, Attr),
    RenderPass17 = proplists:get_value(render_pass17, Attr),
    RenderPass18 = proplists:get_value(render_pass18, Attr),
    RenderPass19 = proplists:get_value(render_pass19, Attr),
    RenderPass20 = proplists:get_value(render_pass20, Attr),
    RenderPass21 = proplists:get_value(render_pass21, Attr),
    RenderPass22 = proplists:get_value(render_pass22, Attr),
    RenderPass23 = proplists:get_value(render_pass23, Attr),
    RenderPass24 = proplists:get_value(render_pass24, Attr),
    RenderPass25 = proplists:get_value(render_pass25, Attr),
    RenderPass26 = proplists:get_value(render_pass26, Attr),
    RenderPass27 = proplists:get_value(render_pass27, Attr),
    RenderPass28 = proplists:get_value(render_pass28, Attr),
    RenderPass29 = proplists:get_value(render_pass29, Attr),
    RenderPass30 = proplists:get_value(render_pass30, Attr),
    RenderPass31 = proplists:get_value(render_pass31, Attr),
    RenderPass32 = proplists:get_value(render_pass32, Attr),
    ...
    println(F, "	<pass_RenderPass_1 sval=\"~s\"/>",[RenderPass1]),
    println(F, "	<pass_RenderPass_2 sval=\"~s\"/>",[RenderPass2]),
    println(F, "	<pass_RenderPass_3 sval=\"~s\"/>",[RenderPass3]),
    println(F, "	<pass_RenderPass_4 sval=\"~s\"/>",[RenderPass4]),
    println(F, "	<pass_RenderPass_5 sval=\"~s\"/>",[RenderPass5]),
    println(F, "	<pass_RenderPass_6 sval=\"~s\"/>",[RenderPass6]),
    println(F, "	<pass_RenderPass_7 sval=\"~s\"/>",[RenderPass7]),
    println(F, "	<pass_RenderPass_8 sval=\"~s\"/>",[RenderPass8]),
    println(F, "	<pass_RenderPass_9 sval=\"~s\"/>",[RenderPass9]),
    println(F, "	<pass_RenderPass_10 sval=\"~s\"/>",[RenderPass10]),
    println(F, "	<pass_RenderPass_11 sval=\"~s\"/>",[RenderPass11]),
    println(F, "	<pass_RenderPass_12 sval=\"~s\"/>",[RenderPass12]),
    println(F, "	<pass_RenderPass_13 sval=\"~s\"/>",[RenderPass13]),
    println(F, "	<pass_RenderPass_14 sval=\"~s\"/>",[RenderPass14]),
    println(F, "	<pass_RenderPass_15 sval=\"~s\"/>",[RenderPass15]),
    println(F, "	<pass_RenderPass_16 sval=\"~s\"/>",[RenderPass16]),
    println(F, "	<pass_RenderPass_17 sval=\"~s\"/>",[RenderPass17]),
    println(F, "	<pass_RenderPass_18 sval=\"~s\"/>",[RenderPass18]),
    println(F, "	<pass_RenderPass_19 sval=\"~s\"/>",[RenderPass19]),
    println(F, "	<pass_RenderPass_20 sval=\"~s\"/>",[RenderPass20]),
    println(F, "	<pass_RenderPass_21 sval=\"~s\"/>",[RenderPass21]),
    println(F, "	<pass_RenderPass_22 sval=\"~s\"/>",[RenderPass22]),
    println(F, "	<pass_RenderPass_23 sval=\"~s\"/>",[RenderPass23]),
    println(F, "	<pass_RenderPass_24 sval=\"~s\"/>",[RenderPass24]),
    println(F, "	<pass_RenderPass_25 sval=\"~s\"/>",[RenderPass25]),
    println(F, "	<pass_RenderPass_26 sval=\"~s\"/>",[RenderPass26]),
    println(F, "	<pass_RenderPass_27 sval=\"~s\"/>",[RenderPass27]),
    println(F, "	<pass_RenderPass_28 sval=\"~s\"/>",[RenderPass28]),
    println(F, "	<pass_RenderPass_29 sval=\"~s\"/>",[RenderPass29]),
    println(F, "	<pass_RenderPass_30 sval=\"~s\"/>",[RenderPass30]),
    println(F, "	<pass_RenderPass_31 sval=\"~s\"/>",[RenderPass31]),
    println(F, "	<pass_RenderPass_32 sval=\"~s\"/>",[RenderPass32]),
