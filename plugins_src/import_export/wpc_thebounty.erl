...
%%  wpc_thebounty.erl
%%
%%     TheBounty Plugin User Interface. (forked from Yafaray plugin)
%%
...
%%                2016 Micheus Source renamed from wpc_yafaray to wpc_thebounty due to new Yafaray implementation
%%
...
help(text, pref_dialog) ->
    [?__(34,"These are user preferences for the TheBounty exporter plugin"),
     ...
     ?__(72,"Executable: The rendering command for the TheBounty raytrace "
        "renderer ('c:/TheBounty/bin/yafaray-xml.exe') that is supposed to "
