...
make_plane([{_,Nres},{_,Size},{_,Thickness},{_,regular},_,_,_,
    ...
    Vs1 = regular_plane_verts(Nres, Size, +Thickness/2) ++
...
make_plane([{_,Nres},{_,Size},{_,Thickness},{_,lumpy},{_,Lumps},_,_,
            {_,Rot_X},{_,Rot_Y},{_,Rot_Z},{_,Mov_X},{_,Mov_Y},{_,Mov_Z},{_,Ground}], _) ->
    Vs1 = lumpy_plane_verts(Nres, Size, Lumps, +Thickness/2) ++
...
make_plane([{_,Nres},{_,Size},{_,Thickness},{_,wavy},{_,Waves},{_,Height},_,
            {_,Rot_X},{_,Rot_Y},{_,Rot_Z},{_,Mov_X},{_,Mov_Y},{_,Mov_Z},{_,Ground}], _) ->
    Vs1 = wavy_plane_verts(Nres, Size, Waves, Height, +Thickness/2) ++
...
make_plane([{_,Nres},{_,Size},{_,Thickness},{_,sombrero},{_,Waves},{_,Height},{_,Falloff},
            {_,Rot_X},{_,Rot_Y},{_,Rot_Z},{_,Mov_X},{_,Mov_Y},{_,Mov_Z},{_,Ground}], _) ->
    Vs1 = sombrero_plane_verts(Nres, Size, Waves, Falloff, Height, +Thickness/2) ++
